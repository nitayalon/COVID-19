...
belgium_K_grid <- c(belgium_grid_search_results_07_06_2020$nation_wide_rtt_results$inner_grid_search_results$K_CI[1], 
               belgium_grid_search_results_07_06_2020$nation_wide_rtt_results$inner_grid_search_results$profile_likelihood_K$k[which.max(belgium_grid_search_results_07_06_2020$nation_wide_rtt_results$inner_grid_search_results$profile_likelihood_K$llk)], 
               belgium_grid_search_results_07_06_2020$nation_wide_rtt_results$inner_grid_search_results$K_CI[2])
belgium_alpha_grid <- c(NA, belgium_grid_search_results_07_06_2020$nation_wide_rtt_results$inner_grid_search_results$profile_likelihood_alpha$alpha[which.max(belgium_grid_search_results_07_06_2020$nation_wide_rtt_results$inner_grid_search_results$profile_likelihood_alpha$llk)], NA)
belgium_trajectories <- lapply(1:3, function(i){predictCovidTrajectory(belgium_grid_search_results_07_06_2020$nation_wide_rtt_results$environment_data, belgium_K_grid[i],belgium_alpha_grid[i],alpha_grid = seq(0.1,0.8,length.out = 40))})
...
dates <- seq(as.Date('22/01/2020',format = '%d/%m/%y'),as.Date('01/11/2020',format = '%d/%m/%y'),'day')
last_date <- as.Date('01/11/2020',format = '%d/%m/%y')
plotTrajectories(belgium_grid_search_results_07_06_2020$nation_wide_rtt_results$environment_data,
                 belgium_grid_search_results_07_06_2020$covid_data_sets$transformed_covid_data[60:nrow(belgium_grid_search_results_07_06_2020$covid_data_sets$transformed_covid_data),],
...
state <- 'Switzerland'
date = '05_25_2020'
swiss_data = uploadTransformData(state)
plot(swiss_data[,1] / 1e3)
plot((swiss_data[,1] - (swiss_data[,2] + swiss_data[,3])) / 1e3)
