plotTransoformedData <- function(nation_data,
  ...
  plot(days, empirical_x / scale_factor, col = 'black', type = 'b', pch=19, lwd = 1, 
       ...
       cex.sub=1.5)
  grid()
  lines(days, empirical_y / scale_factor, col = 'blue', type = 'b', pch=7, lwd = 1, cex = 0.5)
  lines(days, empirical_vw / scale_factor, col = 'blue', type = 'b', pch=2, lwd = 1, cex = 0.5)
  lines(days, transformed_y / scale_factor, col = 'green', type = 'b', pch=7, lwd = 1, cex = 0.5)
  lines(days, transformed_vw / scale_factor, col = 'green', type = 'b', pch=2, lwd = 1, cex = 0.5)
}
