plotTrajectories <- function(empirical_nation_data,
  ...
  lines(seq(min(days),min(days) + (length(empirical_nation_data$X) - 1), 'day'), empirical_nation_data$X / scale_factor, col = 'blue', type = 'b', pch=7, lwd = 1, cex = 0.5)
  lines(seq(min(days),min(days) + (length(empirical_nation_data$X) - 1), 'day'), empirical_nation_data$VW / scale_factor, col = 'blue', type = 'b', pch=13, lwd = 1, cex = 0.5)
  lines(seq(min(days),min(days) + (length(empirical_nation_data$X) - 1), 'day'), empirical_nation_data$Y / scale_factor, col = 'blue', type = 'b', pch=19, lwd = 1, cex = 0.5)
  
  lines(seq(min(days),min(days) + (length(transformed_nation_data$X) - 1), 'day'), transformed_nation_data$X / scale_factor, col = 'blue4', type = 'b', pch=7, lwd = 1, cex = 0.5)
  lines(seq(min(days),min(days) + (length(transformed_nation_data$X) - 1), 'day'), transformed_nation_data$VW / scale_factor, col = 'blue4', type = 'b', pch=13, lwd = 1, cex = 0.5)
  lines(seq(min(days),min(days) + (length(transformed_nation_data$X) - 1), 'day'), transformed_nation_data$Y / scale_factor, col = 'blue4', type = 'b', pch=19, lwd = 1, cex = 0.5)
